...
var u = (i, t, s) => (t in i ? a(i, t, { enumerable: !0, configurable: !0, writable: !0, value: s }) : (i[t] = s));
var o = (i, t, s) => (u(i, typeof t != 'symbol' ? t + '' : t, s), s);
Object.defineProperty(exports, Symbol.toStringTag, { value: 'Module' });
const n = require('electron');
require('path');
const l = require('os'),
  d = require('./ipcMain.js'),
  p = 'my-vue-app',
  g = '0.0.0',
...
class M {
  constructor() {
    o(this, 'loadWindow', null);
    d.installIpcMain();
  }
  createMainWindow() {
    const t = n.Menu.buildFromTemplate(x);
    n.Menu.setApplicationMenu(t),
      n.app.on('render-process-gone', (s, j, r) => {
        const e = { title: '', buttons: [], message: '' };
        switch (r.reason) {
          case 'crashed':
            (e.title = '警告'), (e.buttons = ['确定', '退出']), (e.message = '图形化进程崩溃，是否进行软重启操作？');
            break;
          case 'killed':
            (e.title = '警告'), (e.buttons = ['确定', '退出']), (e.message = '由于未知原因导致图形化进程被终止，是否进行软重启操作？');
            break;
          case 'oom':
            (e.title = '警告'), (e.buttons = ['确定', '退出']), (e.message = '内存不足，是否软重启释放内存？');
            break;
        }
        n.dialog.showMessageBox(this.loadWindow, { type: 'warning', noLink: !0, ...e }).then((c) => {
          c.response === 0 ? this.loadWindow.reload() : this.loadWindow.close();
        });
      });
  }
  loadingWindow() {
    (this.loadWindow = new n.BrowserWindow({ width: 3456, height: 2234, title: 'Main window', webPreferences: { nodeIntegration: !0, contextIsolation: !1 } })),
