...
var u = (i, t, n) => (t in i ? a(i, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (i[t] = n));
var o = (i, t, n) => (u(i, typeof t != 'symbol' ? t + '' : t, n), n);
...
class M {
  ...
  createMainWindow() {
    const t = s.Menu.buildFromTemplate(x);
    s.Menu.setApplicationMenu(t),
      s.app.on('render-process-gone', (n, j, r) => {
        ...
        s.dialog.showMessageBox(this.loadWindow, { type: 'warning', noLink: !0, ...e }).then((c) => {
          c.response === 0 ? this.loadWindow.reload() : this.loadWindow.close();
        });
      });
  }
  loadingWindow() {
    (this.loadWindow = new s.BrowserWindow({ width: 1920, height: 1080, title: 'Main window', webPreferences: { nodeIntegration: !0, contextIsolation: !1 } })),
