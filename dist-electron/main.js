...
var r = (t, e, n) => (u(t, typeof e != 'symbol' ? e + '' : e, n), n);
...
const M = {
  [o.OpenMessagebox]: async (t, e) => s.dialog.showMessageBox(e),
  [o.ReadLocalfile]: async (t, e) => s.dialog.showOpenDialog({ title: '选择文件', properties: ['openFile', 'openDirectory'], ...e }),
};
function W() {
  Object.entries(M).forEach(([t, e]) => {
    s.ipcMain.handle(t, e);
  });
}
class j {
  constructor() {
  ...
  createMainWindow() {
    const e = s.Menu.buildFromTemplate(x);
    s.Menu.setApplicationMenu(e),
      s.app.on('render-process-gone', (n, _, a) => {
        ...
        s.dialog.showMessageBox(this.loadWindow, { type: 'warning', noLink: !0, ...i }).then((c) => {
          c.response === 0 ? this.loadWindow.reload() : this.loadWindow.close();
        });
      });
  }
  loadingWindow() {
    (this.loadWindow = new s.BrowserWindow({ width: 3456, height: 2234, title: 'Main window', webPreferences: { nodeIntegration: !0, contextIsolation: !1 } })),
